    ...
    <>
      ...
      <div className="md:flex md:flex-row md:justify-center md:gap-5 flex flex-col gap-5 md:ml-16 md:mr-16 ml-5 mr-5 ite">
        ...
        <div className="">
            ...
            <h2 className="text-2xl font-bold text-white mt-5">Ahora con el 75% de descuento</h2>
            ...
            <h5 className="text-xl mt-2 font-semibold mb-5 w-full mx-auto text-center bg-white bg p-1">
          ...
          <div className="flex flex-col items-center md:gap-5 gap-2">
            ...
            <h3 className="flex text-white font-bold md:text-xl items-center md:gap-2 gap-1"><FaCheck />Disponibilidad del curso 6 meses</h3>
