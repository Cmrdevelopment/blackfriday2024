      ...
      <div className="md:flex md:flex-row md:justify-center md:gap-5 flex flex-col gap-5 md:ml-16 md:mr-16 ml-5 mr-5 ite">
        ...
        <div className="">
          ...
          <div className="flex flex-col items-center md:gap-5 gap-2">
            ...
            <h3 className="flex text-white font-bold md:text-xl items-center md:gap-2 gap-1"><FaCheck />Curso básico de bolsa online (48 lecciones)</h3>
            <h3 className="flex text-white font-bold md:text-xl items-center md:gap-2 gap-1"><FaCheck /> Curso avanzado PEV online (59 lecciones)</h3>
